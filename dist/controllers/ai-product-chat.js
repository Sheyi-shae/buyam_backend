...
export const aiProductChat = async (req, res, next) => {
    ...
    if (/scam|fraud|fake|illegal/i.test(message)) {
        return res.json({
            reply: "I can’t judge fraud, but I can explain the seller’s reviews, verification status, and what you should confirm before buying."
        });
    }
