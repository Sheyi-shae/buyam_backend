...
export const getUserProfileByPublicId = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const getLoggedInUserDetails = async (req: Request, res: Response, next: NextFunction) => {
...
// update user phone
export const updateUserPhone = async (req: Request, res: Response, next: NextFunction) => {
  const userId = req.user?.id;
...
// update user store
export const updateUserStore = async (req: Request, res: Response, next: NextFunction) => {
  const userId = req.user?.id;
  ...
  try {
    ...
    if (!user.verifiedSeller) {
      const error = new Error('User is not a verified seller') as CustomError;
            error.statusCode = 400;
            throw error;
    }
...
export const getVerifiedSellers = async (req: Request, res: Response, next: NextFunction) => {
